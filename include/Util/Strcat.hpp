...
//from https://stackoverflow.com/questions/1872220/is-it-possible-to-iterate-over-arguments-in-variadic-macros
...
//used to feed macro arguments to the stringstream
#define FEED_ARG(X) << X
#define FEED(...) FOR_EACH(FEED_ARG, __VA_ARGS__)
